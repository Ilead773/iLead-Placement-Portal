    ...
    <div className="dash-page max-w-5xl mx-auto p-4 md:p-6" style={{ paddingBottom: 80 }}>
      ...
      <div className="mb-10 pb-6 border-b border-border-color/60">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight text-primary font-heading">
          Notification <span className="bg-gradient-to-r from-[#2563eb] to-[#dc2626] bg-clip-text text-transparent">Dispatcher</span>
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <motion.div 
            ...
            className="card p-6 md:p-8 bg-card border border-border-color shadow-sm rounded-3xl"
          >
            <h2 className="text-xl font-extrabold text-primary mb-6 flex items-center gap-2 font-heading">
              <Bell size={20} className="text-[#2563eb]" /> Notification Details
            </h2>
        ...
        <div className="lg:col-span-1 space-y-6">
          <motion.div 
            ...
            className="card p-6 bg-card border border-border-color shadow-sm rounded-3xl"
          >
            <h2 className="text-xl font-extrabold text-primary mb-6 flex items-center gap-2 font-heading">
