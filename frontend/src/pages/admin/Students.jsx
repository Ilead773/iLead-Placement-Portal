        ...
        <>
          <div className="table-container">
            <table className="table-wide">
              ...
              <tbody>
                {students.map((s) => (
                  <tr key={s.id} style={selectedIds.includes(s.id) ? { background: 'rgba(124,58,237,0.07)' } : {}}>
                    <td style={{ verticalAlign: 'middle', textAlign: 'center', width: 40 }}>
                      <input
                        type="checkbox"
      ...
      {selectedIds.length > 0 && (
        <div style={{
          ...
          <button
            ...
            style={{ background: 'rgba(255,255,255,0.1)', color: '#fff', border: '1px solid rgba(255,255,255,0.2)', borderRadius: 8, padding: '8px 14px', fontWeight: 600, cursor: 'pointer', fontSize: '0.85rem' }}
          >
            ✕ Clear
          </button>
        </div>
