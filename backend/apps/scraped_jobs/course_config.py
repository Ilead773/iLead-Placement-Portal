...
def normalize_course_name(course_str: str) -> str:
    ...
    mapping = {
        ...
        'bba': 'BBA',
        'bba (gen)': 'BBA',
        'bachelor of business administration (general)': 'BBA',
        'bachelor of business administration (bba)': 'BBA',
        'bba in sport management (bba sm)': 'BBA in Sports Management (BBA SM)',
        'bba in sport management': 'BBA in Sports Management (BBA SM)',
        'bba in data science': 'BSc in Data Science',
        ...
        'b.sc./bachelor in media, animation & graphic design': 'BSc in Multimedia, Animation, Graphic Design (BMAGD)',
        'bachelor of media science': 'BSc in Media Science (BMS)',
