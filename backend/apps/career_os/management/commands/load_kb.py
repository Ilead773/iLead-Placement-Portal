...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        courses_data = [
            ...
            {"name": "BBA in Digital Marketing", "category": "Business & Management"},
            {"name": "BBA in Travel & Tourism Management", "category": "Business & Management"},
            {"name": "BBA in Entrepreneurship", "category": "Business & Management"},
            {"name": "BBA in Sports Management", "category": "Business & Management"},
            {"name": "BBA in Hospital Management", "category": "Business & Management"},
            {"name": "BSc in Media Science", "category": "Media & Creative"},
            {"name": "MSc in Media Science", "category": "Media & Creative"},
            {"name": "BSc in Multimedia, Animation, Graphic Design", "category": "Media & Creative"},
            {"name": "MSc in Multimedia, Animation, Graphic Design", "category": "Media & Creative"},
            {"name": "BSc in Film and Television Production", "category": "Creative Production"},
            ...
            {"name": "BSc in Critical Care Technology", "category": "Healthcare"},
            {"name": "BSc in Medical Laboratory Technology", "category": "Healthcare"},
