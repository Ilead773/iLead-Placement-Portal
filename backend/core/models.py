...
class Student(models.Model):
    ...
    def calculate_category(self):
        # Category A conditions (need >= 3 of 4):
        # 1. attendance >= 75%
        # 2. cgpa >= 8.0
        # 3. backlogs === False (or backlogs_count == 0)
        ...
        # Category B conditions (need >= 3 of 4):
        # 1. attendance >= 50%
        # 2. cgpa >= 6.5
        # 3. backlogs_count <= 2
        ...
        # Category C conditions (need >= 3 of 4):
        # 1. attendance < 30%
        # 2. cgpa < 5.0
        # 3. training_attendance <= 65%
        # 4. backlogs max limit (always satisfied / True)
        cond_c1 = (self.attendance < 30.0) if self.attendance is not None else False
        cond_c2 = (self.cgpa < 5.0) if self.cgpa is not None else False
        cond_c3 = (self.training_attendance <= 65.0) if self.training_attendance is not None else False
        cond_c4 = True  # Always satisfied
        score_c = sum([cond_c1, cond_c2, cond_c3, cond_c4])
