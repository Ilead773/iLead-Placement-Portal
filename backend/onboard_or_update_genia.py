...
# Load custom environment file (e.g. .env.production) if present to avoid hardcoding secrets
...
reg_no = '28941623065'
target_email = 'genia8933@gmail.com'
target_name = 'Genia Saha'
target_phone = '7278565223'

print("=== STARTING GENIA SAHA ONBOARDING/UPDATE ===", flush=True)
...
if not student:
    ...
    student.phone_number = target_phone
...
# 5. Log details in Sent_Emails_Updated.xlsx
